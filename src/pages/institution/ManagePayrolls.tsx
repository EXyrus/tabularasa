  ...
  const { isLoading: isLoadingEmployees, data: employees } = useQuery({
    ...
    queryFn: async () => {
      ...
      return [
        ...
        { id: 'EMP-002', name: 'Jane Smith', position: 'Administrator', department: 'Administration' },
        { id: 'EMP-003', name: 'Michael Johnson', position: 'Junior Teacher', department: 'Mathematics' },
    ...
    <div className="page-container pt-20 animate-fade-in bg-gray-50 dark:bg-gray-900 min-h-screen">
      ...
      <div className="container mx-auto p-4">
        <div className="flex justify-between items-center mb-6">
          <div>
            <Title level={4} className="!mb-1 dark:text-white">Manage Payrolls</Title>
            <Text className="text-gray-500 dark:text-gray-400">Create and manage employee payrolls</Text>
          </div>
          <Button
            type="primary"
            icon={<PlusOutlined />}
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
            ...
            <div className="bg-green-50 dark:bg-green-900/30 p-4 rounded-lg">
              <div className="flex items-center">
                ...
                <div>
                  <Text className="text-gray-500 dark:text-gray-400 text-sm">Total Payroll (Current Month)</Text>
