...
const fetchRoles = async () => {
  ...
  return [
    { id: 1, name: 'Administrator', description: 'Full access to all systems', permissions: ['manage_users', 'manage_roles', 'manage_finances', 'view_reports'] },
    { id: 2, name: 'Teacher', description: 'Can manage classes and student records', permissions: ['manage_classes', 'manage_grades', 'view_student_records'] },
    { id: 3, name: 'Accountant', description: 'Manages financial records and payments', permissions: ['manage_finances', 'view_reports'] },
    { id: 4, name: 'Librarian', description: 'Manages library resources', permissions: ['manage_library'] },
    { id: 5, name: 'Health Staff', description: 'Manages health records', permissions: ['manage_health_records'] },
  ];
};
...
const fetchPermissions = async () => {
  ...
  return [
    ...
    { id: 'manage_finances', name: 'Manage Finances', description: 'Access to financial modules and records' },
    { id: 'manage_classes', name: 'Manage Classes', description: 'Create, update, and delete classes' },
    { id: 'manage_grades', name: 'Manage Grades', description: 'Record and manage student grades' },
    { id: 'view_student_records', name: 'View Student Records', description: 'Access to view student information' },
    { id: 'view_reports', name: 'View Reports', description: 'Access to view system reports' },
    { id: 'manage_library', name: 'Manage Library', description: 'Manage library resources and loans' },
    { id: 'manage_health_records', name: 'Manage Health Records', description: 'Access to health records' },
  ];
};
      ...
      <div className="page-container pt-20 pb-20 px-4 animate-fade-in">
        <div className="flex items-center mb-6">
          ...
          <div>
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400">Create and manage institution roles and permissions</p>
          </div>
        </div>
          ...
          <CardHeader className="pb-3">
            <div className="flex justify-between items-center">
              <div>
                ...
                <CardDescription className="dark:text-gray-400">Manage existing roles or create new ones</CardDescription>
              </div>
          ...
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input placeholder="e.g. Teacher, Accountant" {...field} className="dark:bg-gray-800 dark:border-gray-700" />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
              ...
              <div>
                ...
                <FormMessage className="mt-2">{form.formState.errors.permissions?.message}</FormMessage>
              </div>
