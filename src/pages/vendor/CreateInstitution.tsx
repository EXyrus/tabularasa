...
const CreateInstitution: React.FC = () => {
              ...
              <Col span={12}>
                <div className="border rounded-md p-4 h-full flex flex-col items-center justify-center text-center hover:border-blue-400 hover:shadow-sm transition-all cursor-pointer">
                  <div className="bg-green-100 p-3 rounded-full mb-3">
                    ...
                    >
                      <path
                        d="M22 9H2M14 17H8M6 13H18C18.5523 13 19 12.5523 19 12V6C19 5.44772 18.5523 5 18 5H6C5.44772 5 5 5.44772 5 6V12C5 12.5523 5.44772 13 6 13Z"
                        stroke="currentColor"
                        strokeWidth="2"
                        strokeLinecap="round"
              ...
              <Col span={12}>
                <div className="border rounded-md p-4 h-full flex flex-col items-center justify-center text-center hover:border-blue-400 hover:shadow-sm transition-all cursor-pointer">
                  <div className="bg-orange-100 p-3 rounded-full mb-3">
                    ...
                    >
                      <path
                        d="M17 8H19C20.1046 8 21 8.89543 21 10V16C21 17.1046 20.1046 18 19 18H5C3.89543 18 3 17.1046 3 16V10C3 8.89543 3.89543 8 5 8H7M9 6H15M12 16V12M15 16V14M9 16V14"
                        stroke="currentColor"
                        strokeWidth="2"
                        strokeLinecap="round"
                        strokeLinejoin="round"
        ...
        <Card className="w-full max-w-md">
          ...
          <div className="space-y-4">
            <div className="flex justify-end mb-2">
              ...
              <Button type="default" className="mb-4 ml-2">
                Create a Class
              </Button>
            </div>
  ...
  const displayStep = () => {
    ...
    const selectedModuleKeys = Object.keys(selectedModules).filter(
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-12 px-4">
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="flex justify-center">{currentContent}</div>
      </div>
